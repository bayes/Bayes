 ...
 * BayesTestModel.java
 *
 * Created on Jun 4, 2010, 8:51:34 AM
 */

package applications.bayesTestModel;
 ...
 * @author apple
 */
public class BayesTestModel extends javax.swing.JPanel   implements AsciiModel, EnterAsciiPackage, bayes.ApplicationConstants, java.beans.PropertyChangeListener{
      /** Creates new form BayesTestModel */
 public BayesTestModel () {
    ...
    private void initComponents() {
        ...
        jBuildModel.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        jSavePriors.setFont(new java.awt.Font("Lucida Grande", 1, 13));
        ...
        setup_paneLayout.setHorizontalGroup(
            ...
            .add(setup_paneLayout.createSequentialGroup()
                ...
                .add(jserver, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 201, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jPanel1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 240, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(jResetSave, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 128, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE)
        ...
        setup_paneLayout.setVerticalGroup(
            ...
            .add(setup_paneLayout.createSequentialGroup()
                .add(setup_paneLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(setup_paneLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
    ...
    public void              propertyChange(java.beans.PropertyChangeEvent evt){
      ...
      if (evt.getPropertyName().equals(BayesManager.JRUN_JOB_START)){
          ...
          this.setMessage(message);
           ...
           setActive(true);
           File acceptFile       = DirectoryManager.getBayesAcceptFile();
           AllViewers.showMessage(acceptFile);
      }
   ...
   // make sure all data files exist
    ...
    public String            getProgramName(){
       return "BayesTestModel";
    }
    public String            getExtendedProgramName() { return "Test Model" ;}
    ...
    public StringBuilder     getModelSpecificsForParamsFile(int PADLEN, String PADCHAR){
         ...
         String str     =    getAsciiModel().getName();
         buffer.append (IO.pad("Model Name", -PADLEN, PADCHAR ));
         buffer.append(" = "+ str);
         buffer.append(EOL);


         int nvec    =    getAsciiModel().getNumberOfModelVectors();
         ...
         for (int I = 0; I < noDerived; I++) {
             ...
             String derivedStr          =   "Derived " + fi;
             String derivedVal          =   Derived[I];

             buffer.append (IO.pad(derivedStr, -PADLEN, PADCHAR ));
             buffer.append(" = "+derivedVal);
             buffer.append(EOL);
         }
    ...
    public String            getInstructions(){return PACKAGE_INTSRUCTIONS.TEST_MODEL.getInstruction();}
    ...
    private static void createAndShowGUI () {
       ...
       BayesTestModel newContentPane = new BayesTestModel();
